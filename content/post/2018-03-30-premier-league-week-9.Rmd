...
tags:
  ...
  - week 9
  - auto generated
slug: premier-league-week-9
summary: All the stats from week 9 of the premier league! Michael van Gerwen had the highest accuracy of the night with a probability of 0.73 during leg 1 of his battle against Mensur Suljovic.
thumbnailImagePosition: "top"
thumbnailImage: post/2018-03-30-premier-league-week-9_files/figure-html/thumbnail-1.png
...
![Bar plot showing the overall percent of successful throws at doubles and triples, for each player. The players are ranked from lowest (left) to highest (right) along the x-axis according to their success on the triples. A 50% success rate is indicated by the horizontal, dashed, black line.](2018-03-30-premier-league-week-9_files/figure-html/thumbnail-1.png)
...
dart.df %>% 
  ...
  kable("html", 
        ...
        caption = "Summary table for week 9 of the 2018 Unibet Premier League Darts. The games are ordered from the highest (top) to lowest (bottom) player accuracy and 3-dart average.",
        align = c("l", rep("c", 7))) %>% 
...
# Game 1: Simon Whitlock and Gerwyn Price
## Accuracy
...
![Time-series plot showing the probability of each player to hit their intended target throughout the entire match.](2018-03-30-premier-league-week-9_files/figure-html/line-1-1.png)
...
![Final score and checkout (bold) for each player and each leg of the match. A stolen throw is indicated by a blue, bold number. The black line connects the legs that were won to highlight any winning streaks.](2018-03-30-premier-league-week-9_files/figure-html/finish-1-1.png)

# Game 2: Raymond van Barneveld and Michael Smith
## Accuracy
...
![Time-series plot showing the probability of each player to hit their intended target throughout the entire match.](2018-03-30-premier-league-week-9_files/figure-html/line-2-1.png)
...
![Final score and checkout (bold) for each player and each leg of the match. A stolen throw is indicated by a blue, bold number. The black line connects the legs that were won to highlight any winning streaks.](2018-03-30-premier-league-week-9_files/figure-html/finish-2-1.png)

# Game 3: Gary Anderson and Rob Cross
## Accuracy
...
![Time-series plot showing the probability of each player to hit their intended target throughout the entire match.](2018-03-30-premier-league-week-9_files/figure-html/line-3-1.png)
...
![Final score and checkout (bold) for each player and each leg of the match. A stolen throw is indicated by a blue, bold number. The black line connects the legs that were won to highlight any winning streaks.](2018-03-30-premier-league-week-9_files/figure-html/finish-3-1.png)

# Game 4: Mensur Suljovic and Michael van Gerwen
## Accuracy
...
![Time-series plot showing the probability of each player to hit their intended target throughout the entire match.](2018-03-30-premier-league-week-9_files/figure-html/line-4-1.png)
...
![Final score and checkout (bold) for each player and each leg of the match. A stolen throw is indicated by a blue, bold number. The black line connects the legs that were won to highlight any winning streaks.](2018-03-30-premier-league-week-9_files/figure-html/finish-4-1.png)

# Game 5: Daryl Gurney and Peter Wright
## Accuracy
...
![Time-series plot showing the probability of each player to hit their intended target throughout the entire match.](2018-03-30-premier-league-week-9_files/figure-html/line-5-1.png)
...
![Final score and checkout (bold) for each player and each leg of the match. A stolen throw is indicated by a blue, bold number. The black line connects the legs that were won to highlight any winning streaks.](2018-03-30-premier-league-week-9_files/figure-html/finish-5-1.png)
