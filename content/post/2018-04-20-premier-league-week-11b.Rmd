...
tags:
  ...
  - week 11B
  - auto generated
slug: premier-league-week-11b
summary: All the stats from week 11B of the premier league! Michael Smith had the highest accuracy of the night with a probability of 0.64 during leg 6 of his battle against Simon Whitlock.
thumbnailImagePosition: "top"
thumbnailImage: post/2018-04-20-premier-league-week-11b_files/figure-html/thumbnail-1.png
...
![Bar plot showing the overall percent of successful throws at doubles and triples, for each player. The players are ranked from lowest (left) to highest (right) along the x-axis according to their success on the triples. A 50% success rate is indicated by the horizontal, dashed, black line.](2018-04-20-premier-league-week-11b_files/figure-html/thumbnail-1.png)

```{r, results = "asis"}
dart.df %>% 
  group_by(date, thrower) %>% 
  ...
  kable("html", 
        ...
        caption = "Summary table for week 11B of the 2018 Unibet Premier League Darts. The games are ordered from the highest (top) to lowest (bottom) player accuracy and 3-dart average.",
        align = c("l", rep("c", 7))) %>% 
...
# Game 1: Simon Whitlock and Michael Smith
## Accuracy
...
![Time-series plot showing the probability of each player to hit their intended target throughout the entire match.](2018-04-20-premier-league-week-11b_files/figure-html/line-1-1.png)
...
![Final score and checkout (bold) for each player and each leg of the match. A stolen throw is indicated by a blue, bold number. The black line connects the legs that were won to highlight any winning streaks.](2018-04-20-premier-league-week-11b_files/figure-html/finish-1-1.png)

# Game 2: Daryl Gurney and Gary Anderson
## Accuracy
...
![Time-series plot showing the probability of each player to hit their intended target throughout the entire match.](2018-04-20-premier-league-week-11b_files/figure-html/line-2-1.png)
...
![Final score and checkout (bold) for each player and each leg of the match. A stolen throw is indicated by a blue, bold number. The black line connects the legs that were won to highlight any winning streaks.](2018-04-20-premier-league-week-11b_files/figure-html/finish-2-1.png)

# Game 3: Rob Cross and Peter Wright
## Accuracy
...
![Time-series plot showing the probability of each player to hit their intended target throughout the entire match.](2018-04-20-premier-league-week-11b_files/figure-html/line-3-1.png)
...
![Final score and checkout (bold) for each player and each leg of the match. A stolen throw is indicated by a blue, bold number. The black line connects the legs that were won to highlight any winning streaks.](2018-04-20-premier-league-week-11b_files/figure-html/finish-3-1.png)

# Game 4: Michael van Gerwen and Raymond van Barneveld
## Accuracy
...
![Time-series plot showing the probability of each player to hit their intended target throughout the entire match.](2018-04-20-premier-league-week-11b_files/figure-html/line-4-1.png)
...
![Final score and checkout (bold) for each player and each leg of the match. A stolen throw is indicated by a blue, bold number. The black line connects the legs that were won to highlight any winning streaks.](2018-04-20-premier-league-week-11b_files/figure-html/finish-4-1.png)

# Game 5: Simon Whitlock and Daryl Gurney
## Accuracy
...
![Time-series plot showing the probability of each player to hit their intended target throughout the entire match.](2018-04-20-premier-league-week-11b_files/figure-html/line-5-1.png)
...
![Final score and checkout (bold) for each player and each leg of the match. A stolen throw is indicated by a blue, bold number. The black line connects the legs that were won to highlight any winning streaks.](2018-04-20-premier-league-week-11b_files/figure-html/finish-5-1.png)
