...
tags:
  ...
  - week 11A
  - auto generated
slug: premier-league-week-11a
summary: All the stats from week 11A of the premier league! Gary Anderson had the highest accuracy of the night with a probability of 0.61 during leg 8 of his battle against Rob Cross.
thumbnailImagePosition: "top"
thumbnailImage: post/2018-04-19-premier-league-week-11a_files/figure-html/thumbnail-1.png
...
![Bar plot showing the overall percent of successful throws at doubles and triples, for each player. The players are ranked from lowest (left) to highest (right) along the x-axis according to their success on the triples. A 50% success rate is indicated by the horizontal, dashed, black line.](2018-04-19-premier-league-week-11a_files/figure-html/thumbnail-1.png)
...
dart.df %>% 
  ...
  kable("html", 
        ...
        caption = "Summary table for week 11A of the 2018 Unibet Premier League Darts. The games are ordered from the highest (top) to lowest (bottom) player accuracy and 3-dart average.",
        align = c("l", rep("c", 7))) %>% 
...
# Game 1: Michael Smith and Gary Anderson
## Accuracy
...
![Time-series plot showing the probability of each player to hit their intended target throughout the entire match.](2018-04-19-premier-league-week-11a_files/figure-html/line-1-1.png)
...
![Final score and checkout (bold) for each player and each leg of the match. A stolen throw is indicated by a blue, bold number. The black line connects the legs that were won to highlight any winning streaks.](2018-04-19-premier-league-week-11a_files/figure-html/finish-1-1.png)

# Game 2: Rob Cross and Daryl Gurney
## Accuracy
...
![Time-series plot showing the probability of each player to hit their intended target throughout the entire match.](2018-04-19-premier-league-week-11a_files/figure-html/line-2-1.png)
...
![Final score and checkout (bold) for each player and each leg of the match. A stolen throw is indicated by a blue, bold number. The black line connects the legs that were won to highlight any winning streaks.](2018-04-19-premier-league-week-11a_files/figure-html/finish-2-1.png)

# Game 3: Raymond van Barneveld and Simon Whitlock
## Accuracy
...
![Time-series plot showing the probability of each player to hit their intended target throughout the entire match.](2018-04-19-premier-league-week-11a_files/figure-html/line-3-1.png)
...
![Final score and checkout (bold) for each player and each leg of the match. A stolen throw is indicated by a blue, bold number. The black line connects the legs that were won to highlight any winning streaks.](2018-04-19-premier-league-week-11a_files/figure-html/finish-3-1.png)

# Game 4: Peter Wright and Michael van Gerwen
## Accuracy
...
![Time-series plot showing the probability of each player to hit their intended target throughout the entire match.](2018-04-19-premier-league-week-11a_files/figure-html/line-4-1.png)
...
![Final score and checkout (bold) for each player and each leg of the match. A stolen throw is indicated by a blue, bold number. The black line connects the legs that were won to highlight any winning streaks.](2018-04-19-premier-league-week-11a_files/figure-html/finish-4-1.png)

# Game 5: Gary Anderson and Rob Cross
## Accuracy
...
![Time-series plot showing the probability of each player to hit their intended target throughout the entire match.](2018-04-19-premier-league-week-11a_files/figure-html/line-5-1.png)
...
![Final score and checkout (bold) for each player and each leg of the match. A stolen throw is indicated by a blue, bold number. The black line connects the legs that were won to highlight any winning streaks.](2018-04-19-premier-league-week-11a_files/figure-html/finish-5-1.png)
